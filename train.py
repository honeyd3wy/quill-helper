...
class ArgsBase():
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--train_file',
                            type=str,
                            default='/content/drive/MyDrive/cp1/data/train.tsv',
                            help='train file')

        parser.add_argument('--test_file',
                            type=str,
                            default='/content/drive/MyDrive/cp1/data/test.tsv',
                            help='test file')
...
class KoBARTConditionalGeneration(Base):
    def __init__(self, hparams, **kwargs):
        ...
        self.model = BartForConditionalGeneration.from_pretrained('/content/drive/MyDrive/cp1/kobart_summary')
        self.model.train()
        self.bos_token = '<s>'
        self.eos_token = '</s>'
        self.pad_token_id = 0
